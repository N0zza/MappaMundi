...
specific_ideology = input("For a certain ideology only? y/n: ")
if specific_ideology[0] == "y":
	ideology = input("Enter ideology EXACTLY as it is defined in your ideology file: ").lower()
else:
	ideology = None
...
for p in pdx_list:
	...
	with tga_img as im:
		...
		if ideology is not None:
			p_img.save(p_dir + "\\" + tag_name + "_" + ideology + '.tga')
		else:
