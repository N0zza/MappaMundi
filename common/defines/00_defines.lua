...
NDiplomacy = {
	...
	TENSION_STATE_VALUE = 0.0,						-- Tension value gained by annexing one state
	TENSION_CIVIL_WAR_IMPACT = 0.0,					-- civil war multiplier on tension.
	TENSION_NO_CB_WAR = 0.0,							-- Amount of tension generated by a no-CB wargoal
	TENSION_CB_WAR = 0.0,								-- Amount of tension generated by a war with a CB
	TENSION_ANNEX_NO_CLAIM = 0.0,						-- Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 0.0,						-- Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 0.0,						-- Amount of tension generated by annexing a state that is your core
	TENSION_PUPPET = 0.0,								-- Amount of tension generated by puppeting (per state)
	...
	TENSION_GUARANTEE = -5,
	TENSION_FACTION_JOIN = 0.0,
	TENSION_JOIN_ATTACKER = 0.0,						-- scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.25,					-- scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = 0.0,							-- Amount of tension generated by liberating a country. 
	...
	TENSION_CAPITULATE = 0.0,						-- Scale of the amount of tension created by a countries capitulation.
	...
	AUTONOMY_LEVEL_CHANGE_PP_COST_BASE = 0,		-- Base cost of changing level of autonomy
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 0,			-- Annexation cost
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 0,			-- Break free cost
	MAX_SCORE_DIFF_TO_CHANGE_AUTONOMY = 0,			-- The max diff between current freedom score and the cap for next or previous level allowed for changing
	MASTER_BUILD_AUTONOMY_FACTOR = 7,            -- scales autonomy gain from construction by this
	VICTORY_POINT_WORTH_FACTOR = 0,				-- multiplier when calcualting proince worth (surrender)
	VICTORY_POINT_WORTH_FACTOR_WARSCORE = 0,		-- multiplier when calcualting province worth with autonomy/warscore
	PROVINCE_WORTH_FROM_STATE_VALUE_FACTOR_WARSCORE = 0, 	-- multiplier for the average value a province received from state for warscore
	CAPITAL_CAPITULATE_BONUS_SCORE = 0,			-- extra bonus when deciding who to capitulate to (applied to capital holder)
...
NCountry = {
	...
	STATE_VALUE_MANPOWER_FACTOR = 0.5,		-- If a state is not a core we assume we will get 50% of the factory slots
